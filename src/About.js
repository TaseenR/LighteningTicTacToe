...
export default class About extends Lightning.Component {
    ...
    static _template() {
        return {
            ...
            BackText: {
                x: 960, y: 520, mount: 0.5, scale: 0.6,
    ...
    changeFont() {
        ...
        for(let i=0;i<7;i++){
            this.tag(this._showOrder[i]).patch({ text: { fontFace: this._fonts[localStorage.getItem('fontval')] } })
        }
